...
namespace NadekoBot.Services.Database.Models
{
    public class BotConfig : DbEntity
    {
        ...
        public string DMHelpString { get; set; } = "Sorry, I don't respond to DMs. Please use the #commands channel on the Endless Frontier Discord server.";
        public string HelpString { get; set; } = @"Sorry, I don't respond to DMs. Please use the #commands channel on the Endless Frontier server.";
